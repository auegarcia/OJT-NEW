...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2024 at 01:41 PM
...
ALTER TABLE `scheduled`
  ...
  ADD KEY `contactnumber` (`contactnumber`) USING BTREE;
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_ibfk_1` FOREIGN KEY (`login_id`) REFERENCES `login` (`id`),
